...
namespace MvcProject.WebApplication.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(MvcProjectWebApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Name,Address,Email,City,Region,PostalCode,Country,Id")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Address,Email,City,Region,PostalCode,Country,Id")] Company company)
        {
            if (id != company.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcProjectWebApplicationContext.Company'  is null.");
            }
            var company = await _context.Company.FindAsync(id);
            if (company != null)
            {
